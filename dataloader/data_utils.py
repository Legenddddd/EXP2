...
def set_up_datasets(args):
    ...
    if args.dataset == 'StanfordCars':
        import dataloader.StanfordCars.StanfordCars as Dataset
        args.base_class = 96
...
def get_base_dataloader(args):
    ...
    if args.dataset == 'StanfordCars':
        trainset = args.Dataset.StanfordCars(root=args.dataroot, train=True,
                                             index=class_index, base_sess=True)
        testset = args.Dataset.StanfordCars(root=args.dataroot, train=False, index=class_index)
...
def get_new_dataloader(args,session):
    ...
    if args.dataset == 'StanfordCars':
        testset = args.Dataset.StanfordCars(root=args.dataroot, train=False, index=class_new)

    if args.dataset == 'StanfordDogs':
        testset = args.Dataset.StanfordDogs(root=args.dataroot, train=False, index=class_new)

    if args.dataset == 'FGVCAircraft':
        testset = args.Dataset.FGVCAircraft(root=args.dataroot, train=False, index=class_new)
