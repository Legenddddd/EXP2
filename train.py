...
def get_command_line_parser():
    ...
    parser.add_argument('-R', default=40, type=int)
    parser.add_argument('-base_calibration_degree', default=0.05, type=float)
    parser.add_argument('-inc_calibration_degree', default=0.3, type=float)
